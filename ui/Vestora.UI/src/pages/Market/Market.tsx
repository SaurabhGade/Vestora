...
export default function Market() {
  ...
  const columns = [
    { name: "Name", selector: (row: SecurityDTO) => row.companyName, sortable: true },
    { name: "Symbol", selector: (row: SecurityDTO) => row.symbol, sortable: true },
    { name: "ISIN", selector: (row: SecurityDTO) => row.isin, sortable: true },
    { name: "Security Type", selector: (row: SecurityDTO) => row.securityType, sortable: true },
    { name: "Sector", selector: (row: SecurityDTO) => row.sector, sortable: true },
    { name: "Industry", selector: (row: SecurityDTO) => row.industry, sortable: true },
    { name: "Is Active", selector: (row: SecurityDTO) => row.isActive ? "Active" : "In Active", sortable: true },
  ];
